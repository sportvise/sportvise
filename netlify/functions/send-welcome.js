...
const EMAIL_TEMPLATES = {
  fr: {
    ...
    intro: `Votre compte SPORTVISE est actif. Pendant <strong style="color:#10b981">14 jours</strong>, vous avez accès à <strong style="color:#f59e0b">vos 11 agents experts</strong>, sans limite. Ensuite, vous gardez 3 agents gratuitement — ou passez à Plus pour continuer avec toute l'équipe.`,
    sportLabel: (sport) => `⚽ Sport détecté : ${sport}`,
    sportSubLabel: 'Vos agents sont déjà adaptés à votre sport !',
    agentsTitle: 'Vos 11 agents — débloqués pendant votre essai',
    agentRoles: [
      'Manager Sportif',
      'Préparation Mentale',
      'Nutrition Sportive',
  ...
  de: {
    ...
    intro: `Ihr SPORTVISE-Konto ist aktiv. <strong style="color:#10b981">14 Tage lang</strong> haben Sie Zugriff auf <strong style="color:#f59e0b">alle 11 Experten-Agenten</strong>, ohne Einschränkung. Danach behalten Sie 3 Agenten kostenlos — oder wechseln Sie zu Plus, um mit dem ganzen Team weiterzumachen.`,
    sportLabel: (sport) => `⚽ Erkannte Sportart: ${sport}`,
    sportSubLabel: 'Ihre Agenten sind bereits auf Ihre Sportart abgestimmt!',
    agentsTitle: 'Ihre 11 Agenten — während Ihrer Testphase freigeschaltet',
    agentRoles: [
      'Sportmanager',
      'Mentaltraining',
      'Sporternährung',
  ...
  en: {
    ...
    intro: `Your SPORTVISE account is active. For <strong style="color:#10b981">14 days</strong>, you have access to <strong style="color:#f59e0b">all 11 expert agents</strong>, with no limits. After that, you keep 3 agents for free — or upgrade to Plus to continue with the whole team.`,
    sportLabel: (sport) => `⚽ Sport detected: ${sport}`,
    sportSubLabel: 'Your agents are already tailored to your sport!',
    agentsTitle: 'Your 11 agents — unlocked during your trial',
    agentRoles: [
      'Sports Manager',
      'Mental Coaching',
      'Sports Nutrition',
  ...
  it: {
    ...
    intro: `Il Suo account SPORTVISE è attivo. Per <strong style="color:#10b981">14 giorni</strong> ha accesso a <strong style="color:#f59e0b">tutti gli 11 agenti esperti</strong>, senza limiti. Poi mantiene 3 agenti gratuitamente — oppure passa a Plus per continuare con tutta la squadra.`,
    sportLabel: (sport) => `⚽ Sport rilevato: ${sport}`,
    sportSubLabel: 'I Suoi agenti sono già adattati al Suo sport!',
    agentsTitle: 'I Suoi 11 agenti — sbloccati durante la prova',
    agentRoles: [
      'Manager Sportivo',
